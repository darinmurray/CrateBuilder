alert("Loaded from JS/crate.js");
console.log("Loaded from JS/crate.js");
...
$("#front_container").css(
  "width",
  default_width + handle_depth + handle_depth + border_allowance
); //==========
// handles - front
...
$("#side_left_cleat, #side_right_cleat").css(
  "height",
  default_height - handle_height - border_width
);
...
$("#height").on("input", function (e) {
  ...
  $("#side_left_cleat, #side_right_cleat").css(
    "height",
    user_height - handle_height - border_width
  );
...
$("#length").on("input", function (e) {
  ...
  $("#front_container").css(
    "width",
    user_width + handle_depth + handle_depth + border_allowance
  );
  ...
  $("#top_container").css(
    "width",
    user_width + handle_depth * 2 + border_allowance
  ); //==========
  $("#top").css("width", user_width - border_allowance);
  // $("#top_wrapper .container").css("width", user_width - border_allowance);
});
...
$("#depth").on("input", function (e) {
  ...
  $("#top_container").css(
    "height",
    user_depth + gap_tween_drawings + cleat_thickness * 2 + border_allowance * 2
  );
...
function make_skids(someParam) {
  ...
  if (someParam == "2x4") {
    ...
    $("#front_left_skid, #front_right_skid, #side_right_skid").css(
      "height",
      default_skid_height / 2
    );
    $("#front_left_skid, #front_right_skid").css(
      "width",
      default_skid_width * 2
    );
